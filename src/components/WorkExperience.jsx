  ...
  const experiences = [
    {
      ...
      website: "unihox.com",
      description:
        "Developed scalable web applications serving 500+ users. Coordinated with senior developers.",
      achievements: [
        "Increased application performance by 45% through optimization",
        "Led team of 4 developers on flagship product launch",
        "Implemented CI/CD pipeline reducing deployment time by 50%",
        "Architected cloud infrastructure handling 1k+ requests daily",
      ],
      technologies: [
        "React",
        "Node.js",
            ...
            <div className="sticky top-8">
              ...
              <div className="space-y-4">
                {experiences.map((exp, index) => (
                  <div
                    key={exp.id}
                    className={`group relative cursor-pointer transition-all duration-500 ${activeTab === index
                  ...
                  >
                    ...
                    {/* Timeline Node */}
                    <div
                      className={`absolute left-4 top-6 w-4 h-4 rounded-full border-2 transition-all duration-300 ${activeTab === index
                    ...
                    {/* Content Card */}
                    <div
                      className={`ml-12 p-6 rounded-xl border transition-all duration-500 backdrop-blur-sm ${activeTab === index
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center space-x-3">
                          <div
                            className={`p-2 rounded-lg ${activeTab === index
                              ? "bg-white/20"
                              : "bg-gray-700"
                              }`}
                          >
                          ...
                          <div>
                            <h4
                              className={`font-bold text-lg ${activeTab === index
                                ? "text-white"
                                : "text-gray-200"
                                }`}
                            >
                            ...
                            <p
                              className={`text-sm ${activeTab === index
                                ? "text-blue-100"
                                : "text-gray-400"
                                }`}
                            >
              ...
              <div className="mb-8">
                ...
                <div className="grid gap-4">
                  {currentExperience.achievements.map((achievement, index) => (
                    <div
                      key={index}
                      className={`p-4 bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 hover:border-gray-600 transition-all duration-300 hover:translate-x-2 hover:shadow-lg hover:shadow-blue-500/10 ${isVisible ? "animate-fade-in" : ""
                        }`}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  {currentExperience.technologies.map((tech, index) => (
                    <span
                      key={index}
                      className={`px-4 py-2 bg-gradient-to-r from-gray-800 to-gray-700 rounded-full text-gray-200 text-sm font-medium border border-gray-600 hover:border-blue-500 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/20 cursor-default ${isVisible ? "animate-fade-in" : ""
                        }`}
